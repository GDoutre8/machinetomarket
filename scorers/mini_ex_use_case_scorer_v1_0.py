"""
MTM LOCKED FILE -- DO NOT EDIT

File: mini_ex_use_case_scorer_v1_0.py
Version: v1.0
Status: LOCKED (Production Baseline)
Date Locked: 2026-04-04

This is the locked production version of the Mini Excavator Use Case Scorer.
All scoring logic, thresholds, class rules, hydraulic tier behavior, and caps
are considered production baseline for MTM V1.

If changes are required:
- Create a new version (v1_1, v1_2, etc.)
- Do NOT modify this file directly
- Document all scoring logic changes in the version notes

This scorer is used for:
- Use case scoring
- Attachment suitability scoring
- Listing generation support
...
def _score_hydraulic_thumb(record: MachineRecord) -> UseCaseScore:
    ...
    if gpm is not None:
        if gpm >= 8:
            reasons.append(f"{gpm:.1f} GPM — adequate flow for thumb actuation")
            base = 82
        elif gpm >= 5:
            base = 65
