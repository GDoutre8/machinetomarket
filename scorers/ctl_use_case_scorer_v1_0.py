...
# File:        scorers/ctl_use_case_scorer_v1_0.py
# Version:     v1.0
# Status:      LOCKED (Production Baseline)
# Date Locked: 2026-04-15
# Controls:    CTL use case scoring — 11 use cases, 4 capability classes
#              (A/B/C/D), attachment hydraulic tiers, class-based score boosts.
#              All score thresholds, class boundaries, and gating rules are
#              production baseline for MTM V1.
# Change rule: Create ctl_use_case_scorer_v1_1.py for any logic change.
