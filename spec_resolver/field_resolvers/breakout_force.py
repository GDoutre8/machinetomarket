"""
field_resolvers/breakout_force.py
Resolves bucket_breakout_lb.
"""
...
FIELD = "bucket_breakout_lb"
# v2 mini-ex registry uses bucket_breakout_force_lbs; fall back to FIELD for older
# records and test fixtures that use the resolver-internal key name directly.
_FIELD_V2 = "bucket_breakout_force_lbs"
...
def resolve(ctx: ResolutionContext) -> Optional[FieldResolution]:
    ...
    specs = entry.specs
    registry_val = specs.get(_FIELD_V2) if specs.get(_FIELD_V2) is not None else specs.get(FIELD)
