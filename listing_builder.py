...
_UC_DESCRIPTOR: dict[str, str] = {
    # General site work
    "Grading & Site Prep":              "rough grading and pad preparation",
    "Utility Trenching":                "utility trenching and drainage work",
    "Rock Trenching":                   "rock trenching and hard-material excavation",
    "Material Handling":                "pallet handling and material staging",
    "Truck Loading":                    "truck loading and bulk material transfer",
    "Excavation & Digging":             "footing excavation and drainage work",
    "Foundation Excavation":            "foundation digging and footing work",
    "Land Clearing":                    "lot clearing and site cleanup",
    "Forestry Mulching":                "vegetation management and right-of-way work",
    "Demolition & Breaking":            "concrete breaking and slab demolition",
    "Auger Work":                       "post hole drilling and pier installation",
    "Cold Planing / Asphalt Milling":   "asphalt milling and surface preparation",
    "Stump Grinding":                   "stump removal and below-grade grinding",
    "Snow Removal":                     "snow pushing and lot clearing",
    "Concrete & Flatwork Prep":         "sub-base prep and slab forming",
    "Farm & Agriculture Work":          "field grading and irrigation work",
    "Earthmoving":                      "mass excavation and material movement",
    "Utility Work":                     "utility trenching and site utility installation",
    "Site Prep":                        "site clearing and rough grading",
    "Rough Grading":                    "rough cut grading and earthwork leveling",
    "Drainage Projects":                "drainage trenching and stormwater work",
    "Site Preparation":                 "site clearing, grading, and pad prep",
    # Material handling / staging
    "Yard & Staging Work":              "yard handling and staging operations",
    "Elevated Material Placement":      "rooftop staging and truss placement",
    "Material Staging":                 "on-site material placement and staging",
    # Wheel loader / production
    "Quarry Loading":                   "quarry face loading and truck staging",
    "Aggregate Handling":               "aggregate loading and stockpile management",
    "Mass Material Handling":           "bulk material loading and yard operations",
    # Telehandler-specific
    "Rooftop Material Placement":       "rooftop staging and material placement",
    "Jobsite Reach & Placement":        "elevated placement and jobsite material supply",
    "Elevated Jobsite Supply":          "material supply at height and elevated staging",
    "High-Reach Loading":               "high-reach staging and elevated placement",
    "Pallet Handling":                  "flatbed unloading and pallet distribution",
    "Framing Support":                  "wall panel lifting and framing support",
    "Masonry Support":                  "masonry staging and block placement",
    "Agricultural Use":                 "bale handling and bulk ag material movement",
    # Aerial work platforms
    "Elevated Construction Access":     "elevated work access and overhead positioning",
    "Exterior Structure Work":          "exterior structure and facade access",
    "Overhead Maintenance":             "overhead maintenance and elevated inspection",
}
